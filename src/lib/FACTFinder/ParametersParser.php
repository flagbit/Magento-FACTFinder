...
class FACTFinder_ParametersParser
{
	 ...
	 * @param string (optional) string which will be prepended to the link. if none is given, the scriptname from $_SERVER['REQUEST_URI'] is used
	...
	/**
	 * get target of the current request url
	 *
